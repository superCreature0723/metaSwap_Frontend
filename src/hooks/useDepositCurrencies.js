...
import {getAccount, getCurrencies, getDepositCurrencies} from "../utils/userApi";
import {useTelegram} from "../TelegramContext";
import { BACKEND_URL } from '../utils/constants';

const useDepositCurrencies = () => {
    ...
    useEffect(() => {
        ...
        const fetchCurrencies = async () => {
            ...
            const {error, data} = await getDepositCurrencies(null, webApp?.initData);
...
export default useDepositCurrencies;
