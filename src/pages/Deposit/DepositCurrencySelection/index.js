...
function CurrencySelection() {
    ...
    const { currencies, currenciesConvertedData, loading, error } = useDepositCurrencies();
                            ...
                            {searchTokensList && searchTokensList.map((item, index) => (
                                <li className="tokens__item" key={index}>
                                    <RouterLink
                                        ...
                                        to={`/deposit-replenishment?id=${item?.id}&chain-name=${item?.cryptoChainName}&crypto-name=${item?.cryptoTokenName}`}
